package com.sustainablefarm.modules.producttransformation.resources.equipment.controller;

import com.sustainablefarm.modules.producttransformation.resources.dashboard.service.DtoMapper;
import com.sustainablefarm.modules.producttransformation.resources.equipment.dto.request.EquipmentCreateRequest;
import com.sustainablefarm.modules.producttransformation.resources.equipment.dto.request.EquipmentUpdateRequest;
import com.sustainablefarm.modules.producttransformation.resources.equipment.dto.response.EquipmentResponse;
import com.sustainablefarm.modules.producttransformation.resources.equipment.model.Equipment;
import com.sustainablefarm.modules.producttransformation.resources.equipment.service.EquipmentService;
...
public class EquipmentController {
    ...
    public ResponseEntity<List<EquipmentResponse>> getEquipmentByType(
            @Parameter(description = "Equipment type") @PathVariable com.sustainablefarm.modules.producttransformation.resources.equipment.model.Equipment.EquipmentType equipmentType) {
    ...
    public ResponseEntity<List<EquipmentResponse>> getEquipmentByStatus(
            @Parameter(description = "Maintenance status") @PathVariable com.sustainablefarm.modules.producttransformation.resources.equipment.model.Equipment.MaintenanceStatus maintenanceStatus) {
    ...
    public ResponseEntity<List<EquipmentResponse>> getAvailableEquipment() {
        List<Equipment> equipmentList = equipmentService.getEquipmentByStatus(com.sustainablefarm.modules.producttransformation.resources.equipment.model.Equipment.MaintenanceStatus.ACTIVE);
        List<EquipmentResponse> responses = equipmentList.stream()
                .map(dtoMapper::toResponse)
                .collect(Collectors.toList());
        return ResponseEntity.ok(responses);
