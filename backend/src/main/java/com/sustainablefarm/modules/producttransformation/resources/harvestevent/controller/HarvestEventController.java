package com.sustainablefarm.modules.producttransformation.resources.harvestevent.controller;

import com.sustainablefarm.modules.producttransformation.resources.dashboard.service.DtoMapper;
import com.sustainablefarm.modules.producttransformation.resources.harvestevent.dto.request.HarvestEventCreateRequest;
import com.sustainablefarm.modules.producttransformation.resources.harvestevent.dto.response.HarvestEventResponse;
import com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent;
import com.sustainablefarm.modules.producttransformation.resources.harvestevent.service.HarvestEventService;
...
public class HarvestEventController {
    ...
    public ResponseEntity<List<HarvestEventResponse>> getHarvestEventsByVariety(
            @Parameter(description = "Mango variety") @PathVariable com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.MangoVariety variety) {
    ...
    public ResponseEntity<List<HarvestEventResponse>> getHarvestEventsByGrade(
            @Parameter(description = "Quality grade") @PathVariable com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.QualityGrade grade) {
