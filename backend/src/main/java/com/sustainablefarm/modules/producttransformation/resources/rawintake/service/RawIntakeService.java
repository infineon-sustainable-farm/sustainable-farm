package com.sustainablefarm.modules.producttransformation.resources.rawintake.service;
...
public interface RawIntakeService {
     ...
     */
    List<RawIntake> getRawIntakesByVariety(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.MangoVariety variety);

    /**
     * Get raw intakes by quality grade
     */
    List<RawIntake> getRawIntakesByGrade(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.QualityGrade grade);
     ...
     */
    Double getTotalReceivedQuantityByVariety(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.MangoVariety variety);

    /**
     * Get average quality grade distribution
     */
    long countByReceivedGrade(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.QualityGrade grade);
