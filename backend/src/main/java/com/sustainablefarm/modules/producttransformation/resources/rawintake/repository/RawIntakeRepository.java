package com.sustainablefarm.modules.producttransformation.resources.rawintake.repository;
...
public interface RawIntakeRepository extends JpaRepository<RawIntake, String> {
     ...
     */
    List<RawIntake> findByReceivedVariety(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.MangoVariety receivedVariety);

    /**
     * Find raw intake by quality grade
     */
    List<RawIntake> findByReceivedGrade(com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.QualityGrade receivedGrade);
    ...
    Double getTotalReceivedQuantityByVariety(@Param("variety") com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.MangoVariety variety);

    /**
     * Get average quality grade distribution
     */
    @Query("SELECT COUNT(r) FROM RawIntake r WHERE r.receivedGrade = :grade")
    long countByReceivedGrade(@Param("grade") com.sustainablefarm.modules.producttransformation.resources.harvestevent.model.HarvestEvent.QualityGrade grade);
}