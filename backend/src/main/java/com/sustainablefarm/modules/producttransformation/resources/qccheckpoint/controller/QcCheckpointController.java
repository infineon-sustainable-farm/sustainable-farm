package com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.controller;

import com.sustainablefarm.modules.producttransformation.resources.dashboard.service.DtoMapper;
import com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.dto.request.QcCheckpointCreateRequest;
import com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.dto.request.QcCheckpointUpdateRequest;
import com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.dto.response.QcCheckpointResponse;
...
public class QcCheckpointController {
    ...
    public ResponseEntity<List<QcCheckpointResponse>> getQcCheckpointsByBatchAndStage(
            @Parameter(description = "Batch ID") @PathVariable String batchId,
            @Parameter(description = "QC stage") @PathVariable com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.model.QcCheckpoint.QcStage stage) {
