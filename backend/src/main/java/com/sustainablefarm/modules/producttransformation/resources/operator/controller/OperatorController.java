...
import com.sustainablefarm.modules.producttransformation.resources.operator.dto.request.OperatorUpdateRequest;
...
public class OperatorController {
    ...
    public ResponseEntity<List<OperatorResponse>> getOperatorsByRole(
            @Parameter(description = "Operator role") @PathVariable com.sustainablefarm.modules.producttransformation.resources.operator.model.Operator.Role role) {
    ...
    public ResponseEntity<List<OperatorResponse>> getOperatorsByStatus(
            @Parameter(description = "Active status") @PathVariable com.sustainablefarm.modules.producttransformation.resources.operator.model.Operator.ActiveStatus activeStatus) {
    ...
    public ResponseEntity<List<OperatorResponse>> getActiveOperators() {
        List<Operator> operators = operatorService.getOperatorsByStatus(com.sustainablefarm.modules.producttransformation.resources.operator.model.Operator.ActiveStatus.ACTIVE);
        List<OperatorResponse> responses = operators.stream()
                .map(dtoMapper::toResponse)
                .collect(Collectors.toList());
        return ResponseEntity.ok(responses);
