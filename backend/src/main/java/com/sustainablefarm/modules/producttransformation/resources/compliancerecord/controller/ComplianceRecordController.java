package com.sustainablefarm.modules.producttransformation.resources.compliancerecord.controller;

import com.sustainablefarm.modules.producttransformation.resources.dashboard.service.DtoMapper;
import com.sustainablefarm.modules.producttransformation.resources.compliancerecord.dto.request.ComplianceRecordCreateRequest;
import com.sustainablefarm.modules.producttransformation.resources.compliancerecord.dto.request.ComplianceRecordUpdateRequest;
import com.sustainablefarm.modules.producttransformation.resources.compliancerecord.dto.response.ComplianceRecordResponse;
...
public class ComplianceRecordController {
    ...
    public ResponseEntity<List<ComplianceRecordResponse>> getComplianceRecordsByType(
            @Parameter(description = "Compliance type") @PathVariable com.sustainablefarm.modules.producttransformation.resources.compliancerecord.model.ComplianceRecord.ComplianceType complianceType) {
    ...
    public ResponseEntity<List<ComplianceRecordResponse>> getComplianceRecordsByResult(
            @Parameter(description = "Compliance result") @PathVariable com.sustainablefarm.modules.producttransformation.resources.compliancerecord.model.ComplianceRecord.ComplianceResult result) {
