package com.sustainablefarm.modules.producttransformation.resources.batch.impl;
    ...
    public Batch advanceBatchStatus(String batchId) {
        ...
        if (batch.getCurrentStatus() == BatchStatus.WASHING) {
            long washingCheckpointCount = qcCheckpointService.countByBatchAndStage(batchId, 
                com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.model.QcCheckpoint.QcStage.WASHING);
        ...
        if (batch.getCurrentStatus() == BatchStatus.DRYING) {
            long coolingCheckpointCount = qcCheckpointService.countByBatchAndStage(batchId, 
                com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.model.QcCheckpoint.QcStage.COOLING);
