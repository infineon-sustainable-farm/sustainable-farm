...
class BatchServiceTest {
    ...
    void testMissingMandatoryQCCheckpoint() {
        ...
        when(batchRepository.findById("B-2026-001")).thenReturn(java.util.Optional.of(testBatch));
        when(qcCheckpointService.countByBatchAndStage("B-2026-001", com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.model.QcCheckpoint.QcStage.WASHING)).thenReturn(0L);
    ...
    void testMissingCoolingQCCheckpoint() {
        ...
        when(batchRepository.findById("B-2026-001")).thenReturn(java.util.Optional.of(testBatch));
        when(qcCheckpointService.countByBatchAndStage("B-2026-001", com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.model.QcCheckpoint.QcStage.COOLING)).thenReturn(0L);
