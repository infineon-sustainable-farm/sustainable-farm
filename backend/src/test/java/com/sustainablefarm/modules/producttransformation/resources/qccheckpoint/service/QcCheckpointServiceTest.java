...
import com.sustainablefarm.modules.producttransformation.resources.qccheckpoint.impl.QcCheckpointServiceImpl;
...
class QcCheckpointServiceTest {
    ...
    void setUp() {
        ...
        testOperator.setActiveStatus(com.sustainablefarm.modules.producttransformation.resources.operator.model.Operator.ActiveStatus.ACTIVE);
    }
    ...
    void testCreateMandatoryCheckpoint_ValidStage() {
        // Given
        when(batchRepository.findById("B-001")).thenReturn(java.util.Optional.of(new com.sustainablefarm.modules.producttransformation.resources.batch.model.Batch()));
        when(operatorRepository.findById("OP-001")).thenReturn(java.util.Optional.of(testOperator));
