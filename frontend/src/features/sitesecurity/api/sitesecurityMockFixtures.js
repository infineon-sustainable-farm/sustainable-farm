...
export const ZONES = [
    {
        ...
        entryPoints: 2,
        status: "Open Access",
        description: "Visitor-facing areas around the main entrance, reception and parking. The only part of the farm reachable without a farm-issued credential.",
        requirements: [
    ...
    },
    {
        ...
        entryPoints: 2,
        status: "Monitored",
        description: "Barns, equipment yards and day-to-day operational areas. Staff credentials are required at every gate, and all movement is logged.",
        requirements: [
    ...
    },
    {
        ...
        entryPoints: 1,
        status: "Protected",
        description: "Machinery storage, fuel and utility infrastructure. Access is limited to authorised personnel and routed through a single guarded entry point.",
        requirements: [
    ...
    },
    {
        ...
        entryPoints: 1,
        status: "Locked Down",
        description: "Chemical store and high-value asset containment. Entry requires dual verification and raises a silent notification to the security lead.",
        requirements: [
